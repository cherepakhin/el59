...
import ru.el59.office.parser.ParserE96;
import ru.el59.office.parser.ParserRbt;

public class ParserE96Test {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserE96 parser;
	...
	public void parse() {
		Tovar tovar =null;
		try {
//			tovar = parser.parseTovar(1099648, "http://perm.e96.ru/household_appliances/washing/stiralnye_mashiny/indesit_iwub_4085_cis",null,true,true);
			tovar = parser.parseTovar(1099648, "http://perm.e96.ru/audio_video/tv/televizory/samsung-ue40j6200au?rr=1",null,true,true);
