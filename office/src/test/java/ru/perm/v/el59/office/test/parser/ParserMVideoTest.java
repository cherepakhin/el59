...
import ru.el59.office.parser.ParserMVideo;

public class ParserMVideoTest {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserMVideo parser;
	...
	public void parse() {
		Tovar tovar =null;
		try {
			tovar = parser.parseTovar(1099648, "http://www.mvideo.ru/products/televizor-lg-43lf630v-10007755",null,true,true);
