...
import ru.el59.office.parser.ParserLogoRu;

public class ParserLogoRuTest {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserLogoRu parser;
	...
	public void parse() {
		Tovar tovar =null;
		try {
//			tovar = parser.parseTovar(1099648, "https://www.logo.ru/shop/tehnika-dlya-kuhni/mikrovolnovye-pechi-svch/8335-lg-ms-2342-ds.html",null,true,true);
			tovar = parser.parseTovar(1099648, "https://www.logo.ru/shop/tehnika-dlya-kuhni/holodilniky/179788-volle-vlm-400rwen.html",null,true,true);
			 
//			tovar = parser.parseTovar(1099648, "http://www.logo.ru/shop/kompyuternaya-technika/noutbuki/41139-acer-extensa-ex2510g-345e-nxeeyer012.html",null);
