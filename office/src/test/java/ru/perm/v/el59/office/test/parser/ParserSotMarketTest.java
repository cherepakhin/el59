...
import ru.el59.office.parser.ParserSoftMarket;

public class ParserSotMarketTest {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserSoftMarket parser;
...
//			tovar = parser.parseTovar(1099648, "file:///home/vasi/temp/hc1.html",null);
			// Много картинок
			tovar = parser.parseTovar(1099648, "http://www.sotmarket.ru/product/samsung-ue22h5600ak.html",null,true,true);
