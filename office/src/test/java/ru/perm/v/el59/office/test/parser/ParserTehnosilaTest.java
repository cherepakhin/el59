...
import ru.el59.office.parser.ParserTehnosila;

public class ParserTehnosilaTest {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserTehnosila parser;
	...
	public void parse() {
		Tovar tovar =null;
		try {
			tovar = parser.parseTovar(1099648, "http://www.tehnosila.ru/catalog/tv_i_video/televizory/televizory/-/35282",null,true,true);
//			tovar = parser.parseTovar(1099648, "file:///home/vasi/temp/hc1.html",null,true,true);
