...
public class ParserRbtTest {

	private final static Integer NNUM=1099648;
	@Autowired
	protected ApplicationContext context;
	private ParserRbt parser;
	...
	public void parse() {
		Tovar tovar =null;
		try {
			tovar = parser.parseTovar(1099648, "http://www.rbt.ru/cat/tele-video-audio/televizory/lg_32lf620u/",null,true,true);
