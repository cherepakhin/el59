...
import ru.perm.v.el59.office.iproviders.critery.ContragentCritery;
import ru.perm.v.el59.office.iproviders.dao.CommonCritery;
import ru.perm.v.el59.office.web.ContragentDTO;
...
public class ContragentProvider extends
    ...
    @Override
    public Contragent getByDTO(ru.perm.v.el59.dto.ContragentDTO var1, Shop var2) throws Exception {
        return null;
    }
